...
figure()
[sigma_xx,sigma_yy,thetat]=abc2sigma(aa,bb,cc);
...
for k=1:2000
    ...
    for kk=1:length(cxx)
        ...
        [at,bt,ct]=sigma2abc(7,7,-10*pi);
        lb = [at,bt,ct];
        
        [at,bt,ct]=sigma2abc(20,20,10*pi);
        ub = [at,bt,ct];
...
LoG = sigma_x*sigma_y*(D2Gxx + D2Gyy)/(2*pi*sigma_x*sigma_y);
...
function [sigma_x,sigma_y,theta]=abc2sigma(a,b,c)
